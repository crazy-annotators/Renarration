...
<head>
	...
	<script>
		...
		function applyDivChangesAnnotations(){
			...
			tempAnnotation["@id"] = renarration_url + "annotations?id=" + generateUUID();
			...
			tempAnnotation.target.selector["@id"] = renarration_url + "annotations?type=selector&id=" + generateUUID();
			tempAnnotation.annotatedBy.name = username;
			tempAnnotation.annotatedBy["@id"] = renarration_url + "users?email=" + email;
			tempAnnotation.target["@id"] = renarration_url + "annotations?type=target&id=" + generateUUID();
			...
			if(document.getElementById("text").checked == true){
				...
				tempAnnotation.body["@id"] = renarration_url + "annotations?type=body&id=" +generateUUID();
			...
			if(Parent_selectedElement.tagName=="IMG"){
				...
				if(img_x1.value!="0"){	
					...
					tempAnnotation.target.selector["@id"] = renarration_url + "annotations?type=selector&id=" + generateUUID();
					tempAnnotation.target.selector.members[0]["@id"] = renarration_url + "annotations?type=selectorMember&id=" + generateUUID(); 
					...
					tempAnnotation.target.selector.members[1]["@id"] = renarration_url + "annotations?type=selectorMember&id=" + generateUUID(); 
				}
