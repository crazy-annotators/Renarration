...
<head>
	<meta charset="UTF-8">
	<title>Renarration - Renarration Prototype</title>
	...
	var source_list_selection = {
		...
		var target_audience = '<select id="audience_type=nth="> '+
								'<option value=""></option> '+
								'<option value="rn:Turkish">Turkish</option> '+
...
<body>
	<table width="100%">
		<tr>
			...
			<td width="80%" align="center">	
				...
				<input id = "btnSave" type="submit" value="Save Renarration" onClick="saveRenarration()"/>	
			</td>
			<td width="10%"></td>
		</tr>
		<tr>
	...
	<input type="text" style="display:none;" id="userId" value="<c:out value='<%=request.getSession().getAttribute("userId")%>' />">
